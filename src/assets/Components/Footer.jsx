      ...
      <div>
        <p>
          <span className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">
           হোম ডেলিভারির জন্য কল করুন 
          </span>

          <a
            href="tel:+8801738303747"
        ...
        <ul className="mt-8 space-y-1 text-sm text-gray-700 dark:text-gray-200">
            <li>আমাদের স্বাস্থ্যকর ও সুস্বাদু খাবার পৌঁছে যাবে আপনার দরজায়।</li>
          <li>ডেলিভারি সময়:</li>
            <li>⏰ সকাল ৯টা থেকে রাত ১০টা।</li>
<li>ডেলিভারি চার্জ:</li>
<li>📍 নিকটস্থ এলাকায়: ৩০ টাকা</li>
<li>📍 অন্যান্য এলাকায়: ৬০ টাকা</li>
          <li>অর্ডার দিন এবং উপভোগ করুন ইকো প্যারাডাইসের খাবার আপনার বাড়িতে বসেই!</li>
        </ul>

        <ul className="mt-8 flex gap-6">
          <li>
            <a
              href="https://www.facebook.com/EcoParadise41"
              rel="noreferrer"
              target="_blank"
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
              শিশুদের জন্য বিশেষ আয়োজন(Kids Zone)
              </a>
            </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2025. Created by <a href="">Arsaful Lipu</a>. All rights reserved.
        </p>
      </div>
    </div>
  </div>
